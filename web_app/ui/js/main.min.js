app.run(function($rootScope) {
    $rootScope.$on('$routeChangeStart', function(next, current) {
        ...
        ! function() {
            ...
            function t(e, t) { e.classList.add("is-active"), t.style.maxHeight = t.scrollHeight + "px" }

            function n(e, t) { e.classList.remove("is-active"), t.style.maxHeight = null }
            if (e.length > 0)
                for (let i = 0; i < e.length; i++) {
                    const s = e[i],
                        a = s.parentNode,
                        l = s.nextElementSibling;
                    a.classList.contains("is-active") && t(a, l), s.addEventListener("click", function() { a.classList.contains("is-active") ? n(a, l) : t(a, l) })
                }
        }(),
        function() {
            "use strict";
            let e = {
                ...
                init: function(t, n) { e.swipeCallback = n, t.addEventListener("touchstart", function(t) { e.touchStartX = t.changedTouches[0].screenX }, !1), t.addEventListener("touchend", function(t) { e.touchEndX = t.changedTouches[0].screenX, e.handleSwipeGesture() }, !1) },
            ...
            function s(e) { e && clearInterval(e) }
            if (t.length > 0)
                for (let a = 0; a < t.length; a++) {
                    ...
                    u[o].classList.add("is-active"), i(0, c), window.addEventListener("resize", function() { i(0, c) });
                    let m = !1;
                    r && (m = setInterval(function() { n(l, "next") }, r));
                    ...
                    e.init(l, function(e) { "left" === e.direction ? n(l, "next") : "right" === e.direction && n(l, "prev"), s(m) })
                }
        }(),
        function() {
            "use strict";

            document.documentElement.classList.remove("no-js"), document.documentElement.classList.add("js"), window.addEventListener("load", function() { document.body.classList.add("is-loaded") })
        }(),
        function() {
            "use strict";
        ...
        function() {
            ...
            setTimeout(function() {
                ...
                function n() { document.body.classList.remove("modal-is-active"); for (let t = 0; t < e.length; t++) e[t].classList.remove("is-active") }
                ...
                }), document.addEventListener("keydown", function(e) { 27 === (e || window.event).keyCode && n() })
            }, 300);
        }(),
        function() {
            "use strict";
            ...
            setTimeout(function() {
                ...
                function i() {
                    for (let i = 0; i < e.length; i++) {
                        ...
                        n = l, c.getBoundingClientRect().top <= t - n && !s.classList.contains("is-revealed") && (a && 0 !== a ? setTimeout(function() { s.classList.add("is-revealed") }, a) : s.classList.add("is-revealed"))
                    }
                    var n;
                    ! function() {
                ...
                function a() { t = window.innerHeight, n(30, i()) }
            ...
            setTimeout(function() {
                const e = document.getElementsByClassName("smooth-scroll"),
                    t = (e, n, i, s, a) => {
                        const l = n - e;
                        let c = l / i;
                        const o = function(e) { return e < .5 ? 2 * e * e : (4 - 2 * e) * e - 1 }(c = Math.min(c, 1));
